package com.mongoProject.pkg.config;
...
import com.mongoProject.pkg.dto.AuthorDTO;
import com.mongoProject.pkg.dto.CommentDTO;
	...
	public void run(String... args) throws Exception {
	    ...
	    if (userRepository.count() == 0) {
	        ...
	        Post post1 = new Post(null, sdf.parse("21/03/2018"), 
	            "Partiu viagem", "Vou viajar para SP, abracos!", new AuthorDTO(maria));
